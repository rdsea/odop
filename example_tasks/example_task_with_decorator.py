...
@task_manager.odop_task(
    name="example_task", time="2h", cpu="2", memory="2G", parameter1=1
)
...
@task_manager.odop_task(
    name="heavy_work_process", time="10s", cpu="1", memory="1G", parameter1=1
)
...
@task_manager.odop_task(
    name="heavy_work_thread", time="5s", cpu="1", memory="1G", parameter1=1
)
