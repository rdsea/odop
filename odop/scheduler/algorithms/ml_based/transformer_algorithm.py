...
class TransformerModel(nn.Module):
    def __init__(self, input_dim, num_classes, d_model=128, nhead=8, num_encoder_layers=3, dim_feedforward=512, dropout=0.1):
...
class TransformerTaskAssignment():
    def __init__(self, config: dict):
        ...
        self.model = TransformerModel(self.input_dim, self.num_classes, self.d_model, self.nhead, self.num_encoder_layers, self.dim_feedforward, self.dropout)
